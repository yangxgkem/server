/*
	云风lua-bson设计说明：http://blog.codingnow.com/2013/06/lua_bson.html
	云风lua-bson：https://github.com/cloudwu/lua-bson
	bson官网：http://bsonspec.org/
	bson类型说明：http://bsonspec.org/spec.html
	bson例子：http://bsonspec.org/faq.html
*/
...
#define BSON_REAL 1 //double
#define BSON_STRING 2 //string
#define BSON_DOCUMENT 3 //document
#define BSON_ARRAY 4 //document array
#define BSON_BINARY 5 //binary
#define BSON_UNDEFINED 6 //Undefined
#define BSON_OBJECTID 7 //mongo ObjectId
#define BSON_BOOLEAN 8 //boolean 0false 1true
#define BSON_DATE 9 //int64 UTC datetime
#define BSON_NULL 10 //Null value
#define BSON_REGEX 11 //cstring
#define BSON_DBPOINTER 12 //string DBPointer
#define BSON_JSCODE 13 //string JavaScript code
#define BSON_SYMBOL 14 //string Deprecated
#define BSON_CODEWS 15 //code_w_s JavaScript code w/ scope
#define BSON_INT32 16 //int32
#define BSON_TIMESTAMP 17 //int64 Timestamp
#define BSON_INT64 18 //int64
#define BSON_MINKEY 255 //Min key
#define BSON_MAXKEY 127 //Max key
